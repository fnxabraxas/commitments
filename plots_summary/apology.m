...
xcol=6;
file='data/SD_eAF0.01_g-999_b2_e0.1_epsi0.25_delta4_00.dat';
cST=[ 'b' 'b' 'r' 'c' ];
sST=[ 'o' 'o' '*' 'd' ];
lST={ '-' '-- ' '-' '-'};
colS=[15  5 16 22 ] + 6;
...
fileinp={'data/SD_eAF0.01_g-999_b2_e0.1_epsi0.25_delta4_00.dat';'data/SD_eAF0.01_g-999_b2_e0.1_epsi0.25_delta4_10.dat';'data/SD_eAF0.01_g-999_b2_e0.1_epsi0.25_delta4_01.dat';'data/SD_eAF0.01_g-999_b2_e0.1_epsi0.25_delta4_11.dat'};
colSUB=[5 5 5 3];
...
xcol=6;
file='data/SD_eAF0.01_g-999_b2_e0.1_epsi0.25_delta4_10.dat';
cST=[ 'b' 'b' 'r' 'c' ];
sST=[ 'o' 'o' '*' 'd' ];
lST={ '-' '-- ' '-' '-'};
colS=[22  6 26 34 ] + 6;
...
xcol=6;
file='data/SD_eAF0.01_g-999_b2_e0.1_epsi0.25_delta4_01.dat';
cST=[ 'b' 'b' 'r' 'c' ];
sST=[ 'o' 'o' '*' 'd' ];
lST={ '-' '-- ' '-' '-'};
colS=[22  6 26 34 ] + 6;
