...
S={'-1' '-1' '1' '1' '0.5' '-0.5' '-0.2' '-0.8'};
T={'2' '0' '0' '2' '1.5' '1.5' '0.2' '0.8' };
...
xcol=6;
file= [ 'data/SD_eAF0.01_g-999_S' S{ig} '_T' T{ig} '_e0.01_epsi0.25_delta4_11.dat' ]
cST=[ 'b' 'b' 'r' 'c' ];
sST=[ 'o' 'o' '*' 'd' ];
lST={ '-' '-- ' '-' '-'};
colS=[22  6 26 34 ] + 6;
...
for i=1:length(colS)
  h=plot(INPM.data(:,xcol),INPM.data(:,colS(i)-1)+INPM.data(:,colS(i))+INPM.data(:,colS(i)+1)+INPM.data(:,colS(i)+2)-INPM.data(:,colNC-1)-INPM.data(:,colNC)-INPM.data(:,colNC+1)-INPM.data(:,colNC+2),[cST(i) lST{i}]);
  set(h,'MarkerSize',2);
end
...
xcol=6;
file= [ 'data/SD_eAF0.01_g-999_S' S{ig} '_T' T{ig} '_e0.1_epsi0.25_delta4_11.dat' ];
cST=[ 'b' 'b' 'r' 'c' ];
sST=[ 'o' 'o' '*' 'd' ];
lST={ '-' '-- ' '-' '-'};
colS=[22  6 26 34 ] + 6;
...
INPM=importdata(file,' ',2);
for i=1:length(colS)
  h(i)=plot(INPM.data(:,xcol),INPM.data(:,colS(i)-1)+INPM.data(:,colS(i))+INPM.data(:,colS(i)+1)+INPM.data(:,colS(i)+2)-INPM.data(:,colNC-1)-INPM.data(:,colNC)-INPM.data(:,colNC+1)-INPM.data(:,colNC+2),[cST(i)  lST{i}]);
  set(h,'MarkerSize',2);
end
%legend(leg,'Location','NorthEast');
plot([-1 9],[0 0],'k.--');
...
leg={'(P,C,*,q=1) { }'; '(P,C,*,q=0) { }'; '(P,D,*,q=1) { }'; '(A,D,*,q=1) { }'};
...
filenameps=['apology_e_F_S' S{ig} '_T' T{ig} '.eps'];
...
xcol=6;
file= [ 'data/SD_eAF0.01_g-999_S' S{ig} '_T' T{ig} '_e0.1_epsi0.25_delta4_00.dat' ];
cST=[ 'b' 'b' 'r' 'c' ];
sST=[ 'o' 'o' '*' 'd' ];
lST={ '-' '-- ' '-' '-'};
colS=[15  5 16 22 ] + 6;
...
INPM=importdata(file,' ',2);
for i=1:length(colS)
  if(i==4) h=plot(INPM.data(:,xcol),INPM.data(:,colS(i)-1)+INPM.data(:,colS(i))+INPM.data(:,colS(i)+1)+INPM.data(:,colS(i)+2)-INPM.data(:,colNC-1)-INPM.data(:,colNC)-INPM.data(:,colNC+1)-INPM.data(:,colNC+2),[cST(i) lST{i}]);
  else  h=plot(INPM.data(:,xcol),INPM.data(:,colS(i))-INPM.data(:,colNC)-INPM.data(:,colNC+1)-INPM.data(:,colNC+2),[cST(i) lST{i}]);  end
  set(h,'MarkerSize',2);
end
%legend(leg,'Location','NorthEast');
plot([-1 9],[0 0],'k.--');
...
filenameps=['apology_F_S' S{ig} '_T' T{ig} '.eps'];
print ('-depsc',filenameps);
mv2=['mv ' filenameps ' plots/.' ]; system(mv2);
...
fileinp={[ 'data/SD_eAF0.01_g-999_S' S{ig} '_T' T{ig} '_e0.1_epsi0.25_delta4_00.dat' ];[ 'data/SD_eAF0.01_g-999_S' S{ig} '_T' T{ig} '_e0.1_epsi0.25_delta4_10.dat' ]; [ 'data/SD_eAF0.01_g-999_S' S{ig} '_T' T{ig} '_e0.1_epsi0.25_delta4_01.dat' ]; ['data/SD_eAF0.01_g-999_S' S{ig} '_T' T{ig} '_e0.1_epsi0.25_delta4_11.dat' ]};
colSUB=[5 5 5 3];
...
filenameps=['apology_L_S' S{ig} '_T' T{ig} '.eps'];
print ('-depsc',filenameps);
mv2=['mv ' filenameps ' plots/.' ]; system(mv2);
...
xcol=6;
file= [ 'data/SD_eAF0.01_g-999_S' S{ig} '_T' T{ig} '_e0.1_epsi0.25_delta4_10.dat' ];
cST=[ 'b' 'b' 'r' 'c' ];
sST=[ 'o' 'o' '*' 'd' ];
lST={ '-' '-- ' '-' '-'};
colS=[22  6 26 34 ] + 6;
...
xcol=6;
file= [ 'data/SD_eAF0.01_g-999_S' S{ig} '_T' T{ig} '_e0.1_epsi0.25_delta4_01.dat' ];
cST=[ 'b' 'b' 'r' 'c' ];
sST=[ 'o' 'o' '*' 'd' ];
lST={ '-' '-- ' '-' '-'};
colS=[22  6 26 34 ] + 6;
...
filenameps=['apology_F4_S' S{ig} '_T' T{ig} '.eps'];
print ('-depsc',filenameps);
mv2=['mv ' filenameps ' plots/.' ]; system(mv2);
